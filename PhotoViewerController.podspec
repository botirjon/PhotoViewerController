...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of PhotoViewerController.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/botirjon.nasridinov@gmail.com/PhotoViewerController'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'botirjon.nasridinov@gmail.com' => 'botirjon.nasridinov@gmail.com' }
  s.source           = { :git => 'https://github.com/botirjon.nasridinov@gmail.com/PhotoViewerController.git', :tag => s.version.to_s }
